...
type ApiShutdownPostRequest struct {
	ctx context.Context
	ApiService *HealthAPIService
}

func (r ApiShutdownPostRequest) Execute() (*http.Response, error) {
	return r.ApiService.ShutdownPostExecute(r)
}
...
func (a *HealthAPIService) ShutdownPostExecute(r ApiShutdownPostRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "HealthAPIService.ShutdownPost")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/shutdown"
