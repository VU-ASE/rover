...
type ApiFqnsGetRequest struct {
	ctx context.Context
	ApiService *ServicesAPIService
}

func (r ApiFqnsGetRequest) Execute() ([]FqnsGet200ResponseInner, *http.Response, error) {
	return r.ApiService.FqnsGetExecute(r)
}

/*
FqnsGet Retrieve a list of all fully qualified services

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiFqnsGetRequest
*/
func (a *ServicesAPIService) FqnsGet(ctx context.Context) ApiFqnsGetRequest {
	return ApiFqnsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []FqnsGet200ResponseInner
func (a *ServicesAPIService) FqnsGetExecute(r ApiFqnsGetRequest) ([]FqnsGet200ResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []FqnsGet200ResponseInner
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServicesAPIService.FqnsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/fqns"
