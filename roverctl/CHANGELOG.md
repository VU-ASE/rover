...
## [1.8.1](https://github.com/VU-ASE/roverctl/compare/v1.8.0...v1.8.1) (2025-01-23)


### Bug Fixes

* don't hide update button if no update found (yet) ([e067d30](https://github.com/VU-ASE/roverctl/commit/e067d30cfa05acebfd049829f26022994a8b7ed6))

## [1.8.0](https://github.com/VU-ASE/roverctl/compare/v1.7.0...v1.8.0) (2025-01-23)


### Features

* SSH into Rover ([3e038ff](https://github.com/VU-ASE/roverctl/commit/3e038fff45803d0d3eae086fb6b126ffa165ffc0))


### Bug Fixes

* constrain cursor on overview page when filtering ([26db525](https://github.com/VU-ASE/roverctl/commit/26db525c721e4c3609042f6fd662ede6a01f15ff))
* update comparison without 'v' prefix ([ded8138](https://github.com/VU-ASE/roverctl/commit/ded81383e785c3a7e00d8329736fc32820c10a91))

## [1.7.0](https://github.com/VU-ASE/roverctl/compare/v1.6.0...v1.7.0) (2025-01-23)


### Features

* update checking and self-updating ([f040c75](https://github.com/VU-ASE/roverctl/commit/f040c752a3c85f739e6bd3fe24ff514de5d679e3))

## [1.6.0](https://github.com/VU-ASE/roverctl/compare/v1.5.0...v1.6.0) (2025-01-22)


### Features

* improved upload capabilities ([4d1678e](https://github.com/VU-ASE/roverctl/commit/4d1678e71521a474da19ddbdff5de49cd2ef0751))


### Bug Fixes

* install message reffering to Rover ([4575e71](https://github.com/VU-ASE/roverctl/commit/4575e71536e6c36e62f720f9f806c2647f413d65))
* shutdown battery unplug warning ([13576f3](https://github.com/VU-ASE/roverctl/commit/13576f313633a9c199e19f8046f6df929cc82ad9))

## [1.5.0](https://github.com/VU-ASE/roverctl/compare/v1.4.0...v1.5.0) (2025-01-17)


### Features

* dialog to install default pipeline if not installed yet ([7c8e044](https://github.com/VU-ASE/roverctl/commit/7c8e044fb29d40fb0eaefd3407f67b7980ebc667))
* dialogs renderer ([4c1fa61](https://github.com/VU-ASE/roverctl/commit/4c1fa616c284089ccdde29cfb55c6264556a7f39))
* side-by-side pipeline view ([d6c905b](https://github.com/VU-ASE/roverctl/commit/d6c905bdc1a4fd07133cc06dd8fc3c5161907094))


### Bug Fixes

* replace variables crash when initializing a service ([2016e74](https://github.com/VU-ASE/roverctl/commit/2016e74b950219762b6c63e6b3f33cf11c5a9c87))

## [1.4.0](https://github.com/VU-ASE/roverctl/compare/v1.3.1...v1.4.0) (2025-01-17)


### Features

* remove unused views, reorganized often used views ([426002c](https://github.com/VU-ASE/roverctl/commit/426002c03cee5c881c1f75a6e43cbd47d64f24d6))

## [1.3.1](https://github.com/VU-ASE/roverctl/compare/v1.3.0...v1.3.1) (2025-01-17)


### Bug Fixes

* empty pipeine ([f52b3bb](https://github.com/VU-ASE/roverctl/commit/f52b3bbfca3a7c4eef1e552098283ad6a69ce1ef))
* updated to work with stricter roverd ([52a50f2](https://github.com/VU-ASE/roverctl/commit/52a50f2269b4c365f9d76ebbb07e1f1fd56d9a51))

## [1.3.0](https://github.com/VU-ASE/roverctl/compare/v1.2.0...v1.3.0) (2025-01-14)


### Features

* auto-save successful connections ([454b41e](https://github.com/VU-ASE/roverctl/commit/454b41e927afad7de39381a536da8aed92134ee1))
* connection management ([0467ecd](https://github.com/VU-ASE/roverctl/commit/0467ecd0400d206bb16cfe06b23f847ccdc4cf7b))
* connection page key bindings ([b14dcc1](https://github.com/VU-ASE/roverctl/commit/b14dcc10d44d47d381865916b70332c535cacfcb))
* improved pipeline manager page ([ca8776e](https://github.com/VU-ASE/roverctl/commit/ca8776ef3d25ebd29739c53860f633adcbb33602))
* initialize with author name ([1d867b3](https://github.com/VU-ASE/roverctl/commit/1d867b33575473662415725c3bb5caac6a6d960e))
* overview page stable ([3a72268](https://github.com/VU-ASE/roverctl/commit/3a722688908015a7293be8ff090066f9e2ec390a))
* overwrite local author to sync into own directory ([d4f285a](https://github.com/VU-ASE/roverctl/commit/d4f285aa681ac58663a08986335d792bca76d129))
* shutdown rover ([f7e9b1e](https://github.com/VU-ASE/roverctl/commit/f7e9b1e55c6b7eb239ca3db422dbdb93046cb4e9))
* utility to install default ASE pipeline ([b413ca9](https://github.com/VU-ASE/roverctl/commit/b413ca96dec971d7d44f8b7cc3aeca69122b1150))


### Bug Fixes

* don't quit roverctl when entering 'q' in service init form ([a497306](https://github.com/VU-ASE/roverctl/commit/a4973063b4b3be7503ca5383346e71e21ff09bb7))
* no longer break downloads if a repo was already initialized ([5b890b5](https://github.com/VU-ASE/roverctl/commit/5b890b53b8a2f092ca310ac7c5f055362868d773))

## [1.2.0](https://github.com/VU-ASE/roverctl/compare/v1.1.0...v1.2.0) (2025-01-07)


### Features

* test new release action ([805dd70](https://github.com/VU-ASE/roverctl/commit/805dd703eeacf10088f6047698fbd94f434e30c2))


### Bug Fixes

* save configuration in ~/.config/rover directory ([6730ce0](https://github.com/VU-ASE/roverctl/commit/6730ce0ed81abcfd250fa206d3983b286a282389))
